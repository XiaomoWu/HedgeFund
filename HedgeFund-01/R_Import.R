...
# 27个文件使用232s
system.time({
    dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/trd.dalyr-2017-03-03/trd.dalyr-2016-08-15-2017-03-03"
    ...
    trd.dalyr <- rbindlist(file.list, use.names = T) # rbindlist
    setnames(trd.dalyr, names(trd.dalyr), tolower(names(trd.dalyr))) # setname
    setorder(trd.dalyr, stkcd, trddt) # sort
    trd.dalyr <- unique(trd.dalyr, by = names(trd.dalyr)) # delete duplicate
})
...
# 导入 trd.cndalym ------------------------------------------------
dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/trd.cndalym-2017-03-03"
file.paths <- list.files(path = dir,
...
# 导入 trd.cnmont ------------------------------------------------
dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/trd.cnmont-2017-03-03"
file.paths <- list.files(path = dir,
...
# 导入 idx.idxtrd -----------------------------------
file.paths <- list.files(path = "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/idx.idxtrd-main-2017-03-03/2016-08-15 - 2017-03-03", pattern = "IDX_Idxtrd[\\(0123456789\\)]*\\.txt$", full.names = T)
file.names <- list.files(path = "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/idx.idxtrd-main-2017-03-03/2016-08-15 - 2017-03-03", pattern = "IDX_Idxtrd[\\(0123456789\\)]*\\.txt$", full.names = F)
file.list <- list()
for (i in seq_along(file.paths)) {
    path <- file.paths[i]
    name <- file.names[i]
...
# 导入 sdi.thrfac day / week / month ------------------------------
dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/sdi.thrfacmonth-2017-03-03"
file.paths <- list.files(dir,
                         pattern = "STK_MKT_ThrfacMonth.txt$",
                         full.names = T)
...
sdi.thrfac <- rbindlist(file.list, use.names = T)
setnames(sdi.thrfac, names(sdi.thrfac), tolower(names(sdi.thrfac)))
sdi.thrfac <- unique(sdi.thrfac, by = names(sdi.thrfac)) # delete duplicate

# 导入trd.nrrate -------------------------------------
dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/trd.nrrate-2016-10-25"
file.paths <- list.files(path = dir,
...
# 导入 shibor.avg -----
dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/shibor-2016-12-30"
file.paths <- list.files(path = dir,
...
# MySQL 写入 sdi.thrfac ----------------------------------------
dbWriteTable(conn.gta, name = "sdi_thrfacmonth", # "sdi_thrfacday", "sdi_thrfacmonth"
            value = sdi.thrfac, 
             row.names = F,
             field.types = list(markettypeid = "varchar(20)",
                                #tradingdate = "date",
                                #tradingweek = "varchar(100)",
                                tradingmonth = "varchar(100)",
                                riskpremium1 = "double",
                                riskpremium2 = "double",
                                smb1 = "double",
                                smb2 = "double",
             ...
             overwrite = T,
             append = F)
#dbSendQuery(conn.gta, "alter table sdi_thrfacmonth add primary key (markettypeid, tradingmonth);") # tradingweek, tradingmonth
