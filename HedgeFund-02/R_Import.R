...
# 27个文件使用232s
system.time({
    dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/trd.dalyr-2017-03-31/trd.dalyr-2017-02-25-2017-03-31"
...
# 导入 trd.weekcm ------------------------------------------------
dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/trd.weekcm-2017-03-31"
file.paths <- list.files(path = dir,
...
# 导入 sdi.thrfac day /month ------------------------------
dir <- "C:/Users/rossz/OneDrive/PR/Database-CSMar-Updating/sdi.thrfacweek-2016-09-30"
...
sdi.thrfacmonth <- rbindlist(file.list, use.names = T)


#setnames(sdi.thrfacday, names(sdi.thrfacday), tolower(names(sdi.thrfacday)))
setnames(sdi.thrfacmonth, names(sdi.thrfacmonth), tolower(names(sdi.thrfacmonth)))

#sdi.thrfacday <- unique(sdi.thrfacday, by = names(sdi.thrfacday)) # delete duplicate
sdi.thrfacmonth <- unique(sdi.thrfacmonth, by = names(sdi.thrfacmonth)) # delete duplicate
